<x-app-layout> 
    <div class="pagetitle">
        ...
        <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ __('Add a New Post') }}</li>
            </ol>
        </nav>
    </div>
    <!-- End Page Title -->
                    ...
                    <div class="card-body">
                       ...
                       <form action="{{ route ('post.store') }}" method="post">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-floating mb-3">    
                                    <textarea class="form-control  @error('post') is-invalid @enderror" placeholder="Post" name="post" id="post" style="height: 100px"></textarea>
